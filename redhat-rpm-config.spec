...
Source31:	redhat-rpm-config.ini
...
Patch100:	redhat-rpm-config-recognize-scientific-linux.patch
Patch1000:	redhat-rpm-config-eurolinux.patch
...
- Rebuild with redhat-rpm-config-eurolinux.patch

* Thu Nov 01 2018 Scientific Linux Auto Patch Process <SCIENTIFIC-LINUX-DEVEL@LISTSERV.FNAL.GOV>
- Added Source: redhat-rpm-config.ini
-->  Config file for automated patch script
- Added Patch: redhat-rpm-config-recognize-scientific-linux.patch
...
* Tue Oct 03 2017 Aleksander Baranowski <aleksander.baranowski@euro-linux.com> 9.1.0-76.1
--> Add patch redhat-rpm-config-eurolinux.patch

* Wed Aug 02 2017 Scientific Linux Auto Patch Process <SCIENTIFIC-LINUX-DEVEL@LISTSERV.FNAL.GOV>
- Ran Regex: (Release: .*)%{\?dist}(.*) => \1.sl7\2
